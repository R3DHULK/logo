...
draw = turtle.Turtle()
turtle.title("Created by R3DHULK")
def curve():
...
draw.pen(pencolor="white",fillcolor="green", pensize=3, speed=20)
...
draw.pen(pencolor="white",fillcolor="red", pensize=3, speed=20)
draw.begin_fill()
...
draw.pen(pencolor="white",fillcolor="yellow", pensize=3, speed=20)
draw.begin_fill()
